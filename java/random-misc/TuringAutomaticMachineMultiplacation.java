		...
		while ( halt < 250 ){
			...
			switch (mconfig){
				...
				case print_zero_digit :
						 ...
						 else if (symbol==' '){tape.insert(scannedSquare,"0");scannedSquare++;scannedSquare++;scannedSquare++;mconfig=MCONF.cleanup;}
						 break;
				...
				case print_one_digit :
						 ...
						 else if (symbol==' '){tape.insert(scannedSquare,"1");scannedSquare++;scannedSquare++;scannedSquare++;mconfig=MCONF.cleanup; }
						 break;
				case cleanup :
						 symbol = readSymbol(tape,scannedSquare);
