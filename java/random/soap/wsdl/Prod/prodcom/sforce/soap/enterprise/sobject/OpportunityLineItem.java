...
public class OpportunityLineItem  extends com.sforce.soap.enterprise.sobject.SObject  implements java.io.Serializable {
    ...
    private java.lang.Double maintenance_Amount__c;
    ...
    private java.lang.Boolean processing_Product__c;
    ...
    public OpportunityLineItem(
           ...
           java.lang.Double maintenance_Amount__c,
           ...
           java.lang.Boolean processing_Product__c,
        ...
        this.maintenance_Amount__c = maintenance_Amount__c;
        this.new_CP_Opp__c = new_CP_Opp__c;
        this.opportunity = opportunity;
        this.opportunityId = opportunityId;
        this.pricebookEntry = pricebookEntry;
        this.pricebookEntryId = pricebookEntryId;
        this.processing_Product__c = processing_Product__c;
    ...
    /**
     * Gets the maintenance_Amount__c value for this OpportunityLineItem.
     * 
     * @return maintenance_Amount__c
     */
    public java.lang.Double getMaintenance_Amount__c() {
        return maintenance_Amount__c;
    }


    /**
     * Sets the maintenance_Amount__c value for this OpportunityLineItem.
     * 
     * @param maintenance_Amount__c
     */
    public void setMaintenance_Amount__c(java.lang.Double maintenance_Amount__c) {
        this.maintenance_Amount__c = maintenance_Amount__c;
    }
    ...
    /**
     * Gets the processing_Product__c value for this OpportunityLineItem.
     * 
     * @return processing_Product__c
     */
    public java.lang.Boolean getProcessing_Product__c() {
        return processing_Product__c;
    }


    /**
     * Sets the processing_Product__c value for this OpportunityLineItem.
     * 
     * @param processing_Product__c
     */
    public void setProcessing_Product__c(java.lang.Boolean processing_Product__c) {
        this.processing_Product__c = processing_Product__c;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.maintenance_Amount__c==null && other.getMaintenance_Amount__c()==null) || 
             (this.maintenance_Amount__c!=null &&
              this.maintenance_Amount__c.equals(other.getMaintenance_Amount__c()))) &&
            ...
            ((this.processing_Product__c==null && other.getProcessing_Product__c()==null) || 
             (this.processing_Product__c!=null &&
              this.processing_Product__c.equals(other.getProcessing_Product__c()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getMaintenance_Amount__c() != null) {
            _hashCode += getMaintenance_Amount__c().hashCode();
        }
        ...
        if (getProcessing_Product__c() != null) {
            _hashCode += getProcessing_Product__c().hashCode();
        }
        if (getQuantity() != null) {
    ...
    static {
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("maintenance_Amount__c");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "Maintenance_Amount__c"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "double"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("processing_Product__c");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "Processing_Product__c"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
