...
import org.gazampa.array.sort.mapreduce.SingleMachineMapReduce;
public class TestMapReduceSort{
  ...
  public void testMapReduceIntegrity() {
	...
	SingleMachineMapReduce primitives = new SingleMachineMapReduce(sampleSize, numberOfPartitions);
