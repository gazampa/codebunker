...
public class TuringAutomaticMachineAddition{
	...
	enum Mconfig { b, increment, rewind }
	...
	public static void main(String[] args){
		...
		*
		*
		* Begining at zero, the machine proceeds to increment by 1. It takes a number of cycles ( 5 after the initial 0 to 1 )to complete the increment and uses the same
		...
		*
		* Operatinally, the Machine works from right to left.
		*/
