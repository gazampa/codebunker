...
//Coffee 	3 units of coffee, 1 unit of sugar, 1 unit of cream
	private final String name = BaristaConstants.getDrinkNameCoffee();
	...
	public CoffeeDrink( BigDecimal price){
		this.price = price;
	}
	
	public CoffeeDrink(int unitsOfCoffee, int unitsOfSugar, int unitsOfCream, BigDecimal price){
		this.price=price;
	...
	public boolean equals(Object obj){
		return obj instanceof CoffeeDrink && ((CoffeeDrink)obj).getName().equalsIgnoreCase(name);
	}
