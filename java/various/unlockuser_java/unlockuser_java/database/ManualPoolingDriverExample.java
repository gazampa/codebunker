...
public class ManualPoolingDriverExample {
    ...
    public static void setupDriver(String connectURI) throws Exception {
        ...
        //
        ObjectPool connectionPool = new GenericObjectPool(null,5,(byte)0,10); //<-- Limited Number of Connections to 5, The Webcams Max
        ...
        //
        driver.registerPool("nutter-butter",connectionPool);
    ...
    public static int getNumberOfActiveConnections() throws Exception {
		int result = -1;
        PoolingDriver driver = (PoolingDriver) DriverManager.getDriver("jdbc:apache:commons:dbcp:");
        ObjectPool connectionPool = driver.getConnectionPool("nutter-butter");

        if ( connectionPool!=null ){
			result=connectionPool.getNumActive();
		}
		return result;
    }
    ...
    public static String DriverStatsOutput() throws Exception {
		StringBuilder output = new StringBuilder();
        PoolingDriver driver = (PoolingDriver) DriverManager.getDriver("jdbc:apache:commons:dbcp:");
        ObjectPool connectionPool = driver.getConnectionPool("nutter-butter");

        output.append("NumActive : " + connectionPool.getNumActive());
        output.append(" ");
        output.append("NumIdle : " + connectionPool.getNumIdle());
    ...
    public static void shutdownDriver() throws Exception {
        PoolingDriver driver = (PoolingDriver) DriverManager.getDriver("jdbc:apache:commons:dbcp:");
        driver.closePool("nutter-butter");
    }
}
