...
public class Training_Attendee__c  extends com.sforce.soap.enterprise.sobject.SObject  implements java.io.Serializable {
    ...
    private java.util.Calendar no_Show_Formula__c;

    private java.util.Calendar no_Show_Object_Date__c;
    ...
    public Training_Attendee__c(
           ...
           java.util.Calendar no_Show_Formula__c,
           java.util.Calendar no_Show_Object_Date__c,
        ...
        this.no_Show_Formula__c = no_Show_Formula__c;
        this.no_Show_Object_Date__c = no_Show_Object_Date__c;
    ...
    /**
     * Gets the no_Show_Formula__c value for this Training_Attendee__c.
     * 
     * @return no_Show_Formula__c
     */
    public java.util.Calendar getNo_Show_Formula__c() {
        return no_Show_Formula__c;
    }


    /**
     * Sets the no_Show_Formula__c value for this Training_Attendee__c.
     * 
     * @param no_Show_Formula__c
     */
    public void setNo_Show_Formula__c(java.util.Calendar no_Show_Formula__c) {
        this.no_Show_Formula__c = no_Show_Formula__c;
    }


    /**
     * Gets the no_Show_Object_Date__c value for this Training_Attendee__c.
     * 
     * @return no_Show_Object_Date__c
     */
    public java.util.Calendar getNo_Show_Object_Date__c() {
        return no_Show_Object_Date__c;
    }


    /**
     * Sets the no_Show_Object_Date__c value for this Training_Attendee__c.
     * 
     * @param no_Show_Object_Date__c
     */
    public void setNo_Show_Object_Date__c(java.util.Calendar no_Show_Object_Date__c) {
        this.no_Show_Object_Date__c = no_Show_Object_Date__c;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.no_Show_Formula__c==null && other.getNo_Show_Formula__c()==null) || 
             (this.no_Show_Formula__c!=null &&
              this.no_Show_Formula__c.equals(other.getNo_Show_Formula__c()))) &&
            ((this.no_Show_Object_Date__c==null && other.getNo_Show_Object_Date__c()==null) || 
             (this.no_Show_Object_Date__c!=null &&
              this.no_Show_Object_Date__c.equals(other.getNo_Show_Object_Date__c()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getNo_Show_Formula__c() != null) {
            _hashCode += getNo_Show_Formula__c().hashCode();
        }
        if (getNo_Show_Object_Date__c() != null) {
            _hashCode += getNo_Show_Object_Date__c().hashCode();
        }
    ...
    static {
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("no_Show_Formula__c");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "No_Show_Formula__c"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "dateTime"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("no_Show_Object_Date__c");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "No_Show_Object_Date__c"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "dateTime"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
